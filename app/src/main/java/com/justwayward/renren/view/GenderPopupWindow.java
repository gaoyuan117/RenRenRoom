 ...
 */
package com.justwayward.renren.view;
...
//                dismiss();
     ...
     * 设置喜好
     */
    private void setLike(int type) {
        RetrofitClient.getInstance().createApi().setUserLike(ReaderApplication.token, type)
                .compose(RxUtils.<HttpResult<CommonBean>>io_main())
                .subscribe(new BaseObjObserver<CommonBean>(mActivity) {
                    @Override
