    ...
    public boolean onTouchEvent(MotionEvent e) {
        ...
        switch (e.getAction()) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (NeedCalcu && mx != actiondownX && my != actiondownY) {
                    Log.d("PageWidget", "执行");
...
//                cancel = (actiondownX < mScreenWidth / 2 && mx < mTouch.x) || (actiondownX > mScreenWidth / 2 && mx > mTouch.x);
            ...
            case MotionEvent.ACTION_CANCEL:
                ...
                float x = Math.abs(ux - actiondownX);
                float y = Math.abs(uy - actiondownY);
                if ((x < 30) && (y < 30)) {
                    if ((t - et < 1000)) { // 单击
    ...
    public void recycler() {
        mBackShadowDrawableLR = null; // 有阴影的GradientDrawable
        mBackShadowDrawableRL = null;
        mFolderShadowDrawableLR = null;
        mFolderShadowDrawableRL = null;
        mFrontShadowDrawableHBT = null;
        mFrontShadowDrawableHTB = null;
        mFrontShadowDrawableVLR = null;
        mFrontShadowDrawableVRL = null;
    }
