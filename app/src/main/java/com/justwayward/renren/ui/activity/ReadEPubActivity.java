...
import com.justwayward.renren.ui.adapter.EPubReaderAdapter;
import com.justwayward.renren.ui.adapter.TocListAdapter;
import com.justwayward.renren.utils.FileUtils;
import com.justwayward.renren.view.epubview.DirectionalViewpager;
import com.justwayward.renren.view.epubview.ReaderCallback;
...
public class ReadEPubActivity extends BaseActivity implements ReaderCallback {
    ...
    private void setSpineReferenceTitle() {
        ...
        for (int i = 0; i < trSize; i++) {
            ...
            if (resource != null) {
                //TODO 更改
//                mChapterList.add(new ChapterListBean(resource.getTitle(), resource.getHref()));
            }
        }
    }
