...
//        return SharedPreferencesUtil.getInstance().getInt(getFontSizeKey(bookId), ScreenUtils.dpToPxInt(18));
        return SharedPreferencesUtil.getInstance().getInt(getFontSizeKey(bookId),18);
    }
    ...
    public int getReadTheme() {
        ...
        return SharedPreferencesUtil.getInstance().getInt("readTheme", 2);
    }
     ...
     * 保存用户信息
     */
    public void saveUserInfo(String uid, String token, String nickname) {
        SharedPreferencesUtil.getInstance().putString("uid", uid);
        SharedPreferencesUtil.getInstance().putString("token", token);
        SharedPreferencesUtil.getInstance().putString("nickname", nickname);
    }
